...
data_dir = "data"
file_db = "movie_db.csv"
file_sim_matrix_json = "sim_matrix.json"
file_train = "train_db.json"
current_dir = os.path.dirname(os.path.abspath(__file__))
grandparent_path = os.path.abspath(os.path.join(current_dir, os.pardir, os.pardir))
path_db = os.path.join(grandparent_path, data_dir, file_db)
path_sim_matrix_json = os.path.join(grandparent_path, data_dir, file_sim_matrix_json)
path_train = os.path.join(grandparent_path, data_dir, file_train)

recommend_obj = rec.Recommend(path_db, path_train)
...
async def recommend(interaction: discord.Interaction, movie_title : str, number_of_recommendations: int):
    ...
    try:
        ...
        recommendation_list = recommend_obj.recommend_movie(movie_title, number_of_recommendations, path_sim_matrix_json)
